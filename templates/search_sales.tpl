...
{include file="error_message.tpl"}
  <tr>
    ...
    <td>
	<form name="search_sales_form" method="post" action="SalesReportAction.php{php} echo ("?".strip_tags(SID));{/php}">
        ...
        <tr>
          <td>
            ...
            <tr><td colspan="3" id="vertical-spacer"><img src="images/dot.gif" border="0"/></td>
              ...
              <tr>
                <td colspan="3" class="title"><img src="images/dot.gif" border="0" height="1" width="10"/>Cari Laporan</td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                {if !empty($smarty.post.StartDate_Day)}    
                	<script type="text/javascript">
		             recalculateDate('StartDate_', document.search_sales_form, '{$smarty.post.StartDate_Day}/{$smarty.post.StartDate_Month}/{$smarty.post.StartDate_Year}');
		             recalculateDate('EndDate_', document.search_sales_form, '{$smarty.post.EndDate_Day}/{$smarty.post.EndDate_Month}/{$smarty.post.EndDate_Year}');
		          </script>
		        {/if}
                <tr>
