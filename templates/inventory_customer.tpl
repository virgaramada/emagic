            ...
            <table border="0" cellspacing="0" cellpadding="0" id="inner-table">
              ...
              <tr>
                <td colspan="3" class="title"><img src="images/dot.gif" border="0" height="1" width="10"/>
                 {if !empty($inventoryCustomer)}Ubah{else}Tambah{/if} Tipe Penyaluran</td>
              </tr>
                ...
                <tr>
                  ...
                  <td>
                     {if !empty($inventoryCustomer)}
                        ...
                        {/if}
                  {else}
                    <input type="text" name="customer_type" value="{$smarty.post.customer_type}" onchange="this.value=this.value.toUpperCase();"/>
                  {/if}
                  </td>
                  <tr>
