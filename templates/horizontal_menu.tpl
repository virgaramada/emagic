...
<div id="menubar">
	           ...
	           {if !empty($smarty.session.user_role)}
	                <a title="Keluar" href="LoginAction.php{php} echo ("?".strip_tags(SID));{/php}&amp;method=logout">Keluar</a>
               {/if} 
</div>
{if ($smarty.session.user_role ne 'PTM')} 	
	{if ($smarty.session.user_role eq 'ADM' or $smarty.session.user_role eq 'OWN' or $smarty.session.user_role eq 'OPE' or $smarty.session.user_role eq 'SUP' or $smarty.session.user_role eq 'PUS')}              
		...
		<div id="menu1Content" class="menu">
			<div class="options">
	             ...
	             {if ($smarty.session.user_role eq 'PUS' or $smarty.session.user_role eq 'SUP')}
	                ...
	                <a href="DepotAction.php{php} echo ("?".strip_tags(SID));{/php}">Mgt. Depot</a>
	             ...
	             <a href="WorkInCapitalAction.php{php} echo ("?".strip_tags(SID));{/php}">Mgt. Modal</a>
	              ...
	              {if ($smarty.session.user_role eq 'ADM' or $smarty.session.user_role eq 'OWN' or $smarty.session.user_role eq 'OPE')}
	               <a href="OverheadCostAction.php{php} echo ("?".strip_tags(SID));{/php}">Mgt. Biaya Overhead</a>
	                ...
	                <a href="InventoryOutputAction.php{php} echo ("?".strip_tags(SID));{/php}&amp;productType=BBM">Stand Meter</a>
	                <a href="RealStockAction.php{php} echo ("?".strip_tags(SID));{/php}">Mgt. Real Stock</a>
	               {* <a href="InventoryOutputAction.php{php} echo ("?".strip_tags(SID));{/php}&amp;productType=LUB">Penyaluran Pelumas</a> *}
	                <a href="SalesOrderAction.php{php} echo ("?".strip_tags(SID));{/php}">Permintaan Pengiriman</a>
	...
	<div id="menu2Content" class="menu">
		<div class="options">
			<a href="CheckStockAction.php{php} echo ("?".strip_tags(SID));{/php}">Harian</a>
	                 <a href="CheckStockAction.php{php} echo ("?".strip_tags(SID));{/php}&amp;type=MONTHLY">Bulanan</a>
	                 <a href="CheckStockAction.php{php} echo ("?".strip_tags(SID));{/php}&amp;type=YEARLY">Tahunan</a>
	                 <a href="CheckStockAction.php{php} echo ("?".strip_tags(SID));{/php}&amp;type=SEARCH">Arsip</a>
		</div>
	</div>
</div>
{/if}
...
<div id="menu3Container">
	<div id="menu3Content" class="menu">
		<div class="options">
	                 ...
	                 <a href="CashFlowAction.php{php} echo ("?".strip_tags(SID));{/php}&amp;type=MONTHLY">Bulanan</a>
	                 <a href="CashFlowAction.php{php} echo ("?".strip_tags(SID));{/php}&amp;type=YEARLY">Tahunan</a>
	                 <a href="CashFlowAction.php{php} echo ("?".strip_tags(SID));{/php}&amp;type=SEARCH">Arsip</a>
		</div>
	</div>
</div>
{/if}
...
<div id="menu4Container">
	<div id="menu4Content" class="menu">
		<div class="options">
	                            ...
	                            <a href="SalesReportAction.php{php} echo ("?".strip_tags(SID));{/php}&amp;type=MONTHLY">Bulanan</a>
	                            <a href="SalesReportAction.php{php} echo ("?".strip_tags(SID));{/php}&amp;type=YEARLY">Tahunan</a>
	                            <a href="SalesReportAction.php{php} echo ("?".strip_tags(SID));{/php}&amp;type=SEARCH">Arsip</a>
		</div>
	</div>
</div>
{/if}
