...
<table border="0" cellspacing="0" cellpadding="0">
  <tr><td id="vertical-spacer"><img src="images/dot.gif" border="0"/><h4>Tabel Margin</h4></td></tr>
</table>
<br/>
...
<tr class="title"><td colspan="3" id="vertical-spacer"><img src="images/dot.gif" border="0"/></td>
        ...
        <tr>
          ...
          <td><img src="images/dot.gif" border="0" height="1" width="10"/>{$inv_margin_list[c]->getStartDate()} s.d. {$inv_margin_list[c]->getEndDate()}</td>
