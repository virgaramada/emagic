            ...
            <tr><td colspan="3" id="vertical-spacer"><img src="images/dot.gif" border="0"/></td>
              ...
              <input type="hidden" name="inv_id" value="{$inventoryMargin->getInvId()}"/>
               ...
               {/if}
                ...
                <tr>
                 <td><img src="images/dot.gif" border="0" height="1" width="10"/>Tanggal Berlaku </td>
                 <td colspan="2">{html_select_date start_year='-1' end_year='+1' field_order=DMY prefix='Start_Date_'} s.d. {html_select_date start_year='-1' end_year='+1' field_order=DMY prefix='End_Date_'}</td>
                </tr>
