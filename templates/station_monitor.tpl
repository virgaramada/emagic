              ...
              <tr>
                ...
                {if !empty($smarty.post.StartDate_Day)}    
                	<script type="text/javascript">
		             recalculateDate('StartDate_', document.station_monitor_form, '{$smarty.post.StartDate_Day}/{$smarty.post.StartDate_Month}/{$smarty.post.StartDate_Year}');
		             recalculateDate('EndDate_', document.station_monitor_form, '{$smarty.post.EndDate_Day}/{$smarty.post.EndDate_Month}/{$smarty.post.EndDate_Year}');
		          </script>
		        {/if}
              <tr>
                <td colspan="3" id="vertical-spacer"><img src="images/dot.gif" border="0"/></td>
