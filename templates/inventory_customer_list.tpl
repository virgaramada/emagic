...
{/if}
          ...
          {/section}
           <tr>
              ...
              {if ($smarty.session.user_role == 'SUP' || $smarty.session.user_role == 'PUS')}
              <tr>
                <td colspan="4" align="right"><a id="inv_cust_delete_all" href="InventoryCustomerAction.php?method=deleteAll{php} echo ("&amp;".strip_tags(SID));{/php}" onclick="return confirm('Anda ingin menghapus semua data?');" class="button">Hapus Semua</a><img src="images/dot.gif" border="0" height="1" width="10"/></td>
              </tr>
              <tr>
                <td colspan="4" id="vertical-spacer"><img src="images/dot.gif" border="0"/></td>
              </tr>
