...
{include file="error_message.tpl"}
  <tr>
    ...
    <td>
	<form name="search_cash_flow_form" method="post" action="CashFlowAction.php{php} echo ("?".strip_tags(SID));{/php}">
              ...
              <tr>
                ...
                {if !empty($smarty.post.StartDate_Day)}    
                	<script type="text/javascript">
		             recalculateDate('StartDate_', document.search_cash_flow_form, '{$smarty.post.StartDate_Day}/{$smarty.post.StartDate_Month}/{$smarty.post.StartDate_Year}');
		             recalculateDate('EndDate_', document.search_cash_flow_form, '{$smarty.post.EndDate_Day}/{$smarty.post.EndDate_Month}/{$smarty.post.EndDate_Year}');
		          </script>
		        {/if}
                <tr>
