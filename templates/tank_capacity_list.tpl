...
<tr class="title"><td colspan="4" id="vertical-spacer"><img src="images/dot.gif" border="0"/></td>
        ...
        <tr>
         ...
         {if ($smarty.session.user_role == 'SUP' || $smarty.session.user_role == 'PUS')}
             <tr><td colspan="4" align="right"><a id="tank_cap_delete_all" href="TankCapacityAction.php?method=deleteAll{php} echo ("&amp;".strip_tags(SID));{/php}" onclick="return confirm('Anda ingin menghapus semua data?');">Hapus Semua</a><img src="images/dot.gif" border="0" height="1" width="10"/></td>
            </tr>
