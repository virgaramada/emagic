...
<tr>
   <td>
      ...
      <table align="center" border="0" cellspacing="0" cellpadding="1" id="login-outer">
        <tr>
          <td><table border="0" cellspacing="1" cellpadding="0" id="login-inner">
              ...
              <tr>
                <td colspan="3" align="right"><input type="submit" name="submit" value="masuk" id="submit" class="button"/><img src="images/dot.gif" border="0" height="1" width="10"/></td>
              </tr>
	...
	deleteCookie("PHPSESSID", contextPath);	
	deleteCookie("PHPSESSID", "/", true);
	deleteCookie("PHPSESSID", contextPath, true);
    </script>
