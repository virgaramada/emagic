						...
						<tr>
						 ...
						 <tr>
					      ...
					      <table border="0" cellspacing="0" cellpadding="1" id="outer-table">
						   <tr>
						      <td>
					            ...
					            <tr class="title">
					                <td id="horizontal-spacer"><img src="images/dot.gif" border="0" />Nozzle</td>
					                <td id="horizontal-spacer"><img src="images/dot.gif" border="0" />Tanggal</td>
					               {*  <td id="horizontal-spacer"><img src="images/dot.gif" border="0" />Shift</td>*}
                          ...
                          {section name=c loop=$v}
				             ...
				             <tr>
      							<td id="horizontal-spacer"><img src="images/dot.gif" border="0" />{$v[c]->getNozzleId()}</td>
				                <td id="horizontal-spacer" nowrap>{$v[c]->getOutputDate()}-{$v[c]->getOutputTime()}</td>
				                 {*<td id="horizontal-spacer"><img src="images/dot.gif" border="0" />I</td>*}
