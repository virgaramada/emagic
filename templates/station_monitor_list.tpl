			    ...
			    <h5>{$inv_type_list[d]->getInvDesc()}</h5>
			     <div id="div-outer-table">
			             ...
			             <thead>
			              <tr>
			                ...
			                <th id="supply_value"><img src="images/dot.gif" border="0" height="1" width="10"/>Suplai</th>
			                 <th id="last_supply_date"><img src="images/dot.gif" border="0" height="1" width="10"/>Tgl Suplai Terakhir</th>
			                <th id="sales_value"><img src="images/dot.gif" border="0" height="1" width="10"/>Penjualan</th>
			                <th id="last_output_date"><img src="images/dot.gif" border="0" height="1" width="10"/>Tgl Pengeluaran Terakhir</th>
			                 ...
			                 <th id="through_put"><img src="images/dot.gif" border="0" height="1" width="10"/>Ketahanan Stok (jam)</th>
							             ...
							             {if $ky eq ($inv_type_list[d]->getInvType()|cat:'_'|cat:$v[s]->getStationId())}
							               ...
							               {php} echo($st_number); {/php}
							                ...
							                <td><img src="images/dot.gif" border="0" height="1" width="10"/>
							                 ...
							                 <td><img src="images/dot.gif" border="0" height="1" width="10"/>
							                 {foreach from=$last_supply_date key=lskey item=lsval}
							                       
							                           {if $lskey eq ($inv_type_list[d]->getInvType()|cat:'_'|cat:$v[s]->getStationId())}
							                             {$lsval}
			                                           {/if}
							                 {/foreach}
							                 </td>
							                 ...
							                 {/foreach} Ltr</td>
							                  <td><img src="images/dot.gif" border="0" height="1" width="10"/>
							                 {foreach from=$last_output_date key=lokey item=loval}
							                       
							                           {if $lokey eq ($inv_type_list[d]->getInvType()|cat:'_'|cat:$v[s]->getStationId())}
							                             {$loval}
			                                           {/if}
							                 {/foreach}
							                 </td>
							                 ...
							                 {/foreach}
							                 *}
							                 {foreach from=$through_put_list key=tpkey item=tpval}
							                       
							                           {if $tpkey eq ($inv_type_list[d]->getInvType()|cat:'_'|cat:$v[s]->getStationId())}
															 {php} echo number_format($this->_tpl_vars['tpval'], 2, '.', ','); {/php}
			                                           {/if}
							                 {/foreach}
							                 </td>
			      ...
			      <script type="text/javascript">
			         sortTable($('station_monitor_table_{php} echo($dist_idx); {/php}_{php} echo($inv_idx); {/php}'), 12);
			      </script>
