	...
	<td>
        ...
        <tr>
         ...
         <tr><td colspan="5" id="horizontal-spacer"><img src="images/dot.gif" border="0" />{$paginatedDistributionLocationList}</td></tr>
            ...
            <tr><td colspan="5" align="right"><a id="dist_loc_delete_all" href="DistributionLocationAction.php?method=deleteAll{php} echo ("&amp;".strip_tags(SID));{/php}" onclick="return confirm('Anda ingin menghapus semua data?');" class="button">Hapus Semua</a><img src="images/dot.gif" border="0" height="1" width="10"/></td></tr>
            <tr><td colspan="5" id="vertical-spacer"><img src="images/dot.gif" border="0"/></td></tr>
