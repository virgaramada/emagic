...
<table border="0" cellspacing="0" cellpadding="0">
  <tr><td id="vertical-spacer"><img src="images/dot.gif" border="0"/><h4>Tabel Inventory</h4></td></tr>
</table>
<br/>
...
{if ($smarty.session.user_role == 'SUP')}
 ...
 {if ($smarty.session.user_role == 'SUP')}
          <tr>
   <td colspan="4" align="right"><a id="inv_type_delete_all" href="InventoryTypeAction.php?method=deleteAll{php} echo ("&amp;".strip_tags(SID));{/php}" onclick="return confirm('Anda ingin menghapus semua data?');">Hapus Semua</a><img src="images/dot.gif" border="0" height="1" width="10"/></td>
 </tr>
<tr>
   <td colspan="4" id="vertical-spacer"><img src="images/dot.gif" border="0"/></td>
 </tr>
