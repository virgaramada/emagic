...
class TankCapacity{
    ...
    public final function setTankNumber($tank_number) {
		$this->tank_number = (string) $tank_number;
	}
	public final function getTankNumber() {
		return (string) $this->tank_number;
	}
}
?>