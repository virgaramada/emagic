CREATE DATABASE IF NOT EXISTS emagic;
...
(
	...
	PUMP_ID VARCHAR(10),
	NOZZLE_ID VARCHAR(10),
	OUTPUT_TIME VARCHAR(20),
	CATEGORY VARCHAR(10),
	STATION_ID VARCHAR(50),
	OUTPUT_TIME_SHIFT VARCHAR(10),
	PRIMARY KEY (ID)
) ENGINE = MyISAM;
...
CREATE UNIQUE INDEX UQ_INV_MGT_DIST_LOCATION_1 ON INV_MGT_DIST_LOCATION (LOCATION_CODE ASC);
CREATE UNIQUE INDEX UQ_INV_MGT_SALES_ORDER_1 ON INV_MGT_SALES_ORDER (SALES_ORDER_NUMBER ASC, STATION_ID ASC);
CREATE UNIQUE INDEX UQ_INV_MGT_STATION_1 ON INV_MGT_STATION (STATION_ID ASC);
CREATE UNIQUE INDEX UQ_INV_MGT_TYPE_1 ON INV_MGT_TYPE (INV_TYPE ASC);
CREATE UNIQUE INDEX UQ_INV_MGT_USER_ROLE_1 ON INV_MGT_USER_ROLE (USER_NAME ASC);